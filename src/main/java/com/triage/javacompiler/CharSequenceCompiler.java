...
public class CharSequenceCompiler<T> {
    ...
    *            <var>types</var>.
    */
   public synchronized CompileResult compile(final String qualifiedClassName,
      ...
      CompileResult result = compiled.get(qualifiedClassName);
      return result;
   }
    ...
    */
   public synchronized Map<String, CompileResult> compile(
         final Map<String, CharSequence> classes,
         final DiagnosticCollector<JavaFileObject> diagnosticsList)
         throws CharSequenceCompilerException {
      Map<String, JavaFileObject> sources = new HashMap<String,JavaFileObject>();
      for (Entry<String, CharSequence> entry : classes.entrySet()) {
         ...
         if (javaSource != null) {
            ...
            final JavaFileObjectImpl source = new JavaFileObjectImpl(className,
                  javaSource);
            sources.put(qualifiedClassName, source);
